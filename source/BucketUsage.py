...
def getBuckets(credential_object, project_id):
    col = [
        ...
        "storageClass",
        "creation_time",
        "isDefaultEventBasedHoldEnabled",
        "rpo",
        "isBucketPolicyEnabled",
    ...
    try:
        ...
        bucket_df = bucket_df.astype(
            {
                "isDefaultEventBasedHoldEnabled": bool,
                "isBucketPolicyEnabled": bool,
        ...
        while request is not None:
            ...
            for bucket in buckets:
                ...
                isUniformBucketLevelAccessEnabled = iamConfigurations[
                ...
                data_dict = {
                    ...
                    "isDefaultEventBasedHoldEnabled": isDefaultEventBasedHoldEnabled,
                    "rpo": rpo,
